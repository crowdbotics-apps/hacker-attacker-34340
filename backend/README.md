...
## Project Structure
    ...
    ├── hacker_attacker_34340  # Django project configurations
...
1. Clone this repo and `cd hacker_attacker_34340`
...
2. Clone this repo and `cd hacker_attacker_34340`
